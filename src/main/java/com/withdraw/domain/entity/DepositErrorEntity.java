...
@Entity(name = "deposit_error")
@Table(name = "deposit_error")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class DepositErrorEntity {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long id;

    public DepositErrorEntity(Long transId, Long userId, Double amount, byte retryCount, String errorLog, String status) {
    ...
    public DepositErrorEntity(Long transId, Long userId, Double amount) {
